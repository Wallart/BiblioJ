	...
	<body>
		...
		<div id="show-reservation" class="content scaffold-show" role="main">
			...
			<ol class="property-list reservation">
				...
				<g:if test="${reservationInstance?.livre}">
				<li class="fieldcontain">
					<span id="livre-label" class="property-label"><g:message code="reservation.livre.label" default="Livre" /></span>
					
						<g:each in="${reservationInstance.livre}" var="l">
